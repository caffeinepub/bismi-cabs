...
interface ShareAppLinkCardProps {
  siteDeleted?: boolean;
}

export function ShareAppLinkCard({ siteDeleted = false }: ShareAppLinkCardProps) {
      ...
      <Card className="border-destructive/50 bg-destructive/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg">Sharing Disabled</CardTitle>
          </div>
          <CardDescription>
            This website has been deleted and sharing is no longer available.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Alert variant="destructive">
            ...
            <AlertDescription className="text-sm">
              The website has been permanently deleted. All links are now inactive and cannot be shared.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
