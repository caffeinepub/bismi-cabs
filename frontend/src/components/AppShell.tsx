...
export function AppShell({ children, onNavigate, siteDeleted = false }: AppShellProps) {
  ...
  // 5. Site is not deleted
  const showLeadsNav = ownerMode && isAuthenticated && isAuthorizationFetched && isAuthorized === true && !siteDeleted;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
            ...
            {!siteDeleted && (
              <Dialog>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  ...
                  <ShareAppLinkCard siteDeleted={siteDeleted} />
                </DialogContent>
              </Dialog>
            )}

            {isAuthenticated && !siteDeleted && (
              <DropdownMenu>
      ...
      {/* Bottom Navigation (Mobile) - Only show in owner mode when authorized and site not deleted */}
      {showLeadsNav && (
      ...
      {/* Desktop Navigation - Only show in owner mode when authorized and site not deleted */}
      {showLeadsNav && (
