...
import type { BookingLead as _BookingLead, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createBookingLead(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string | null): Promise<BookingLead> {
        if (this.processError) {
            try {
                const result = await this.actor.createBookingLead(arg0, arg1, arg2, arg3, arg4, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg5));
                return from_candid_BookingLead_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_BookingLead_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BookingLead): BookingLead {
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BookingLead>): Array<BookingLead> {
    return value.map((x)=>from_candid_BookingLead_n4(_uploadFile, _downloadFile, x));
}
